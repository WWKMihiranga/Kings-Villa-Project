...
function RoomCategories() {
  return (
    <div>
      <div className="title">ROOM & SUITES</div>

      <div className="product-list">
        <div className="product-box1">
          <img src={double_room} alt="deluxe-double-room" className="product-img" />
          <div className="product-desbox">
            <h2 className="product-title">DELUXE DOUBLE ROOM</h2>
            <div className="product-des">
              <p>Max 2 Guests<br />1 King bed</p>
        ...
        <div className="product-box">
          <img src={double_room} alt="deluxe-triple-room" className="product-img" />
          <div className="product-desbox">
            <h2 className="product-title">DELUXE TRIPLE ROOM</h2>
            <div className="product-des">
              <p>Max 3 Guests<br />1 King bed and 1 single bed</p>
              <p className="price">$10</p>
            </div>
          </div>
        </div>
        ...
        <div className="product-box">
          ...
          <div className="product-desbox">
            ...
            <div className="product-des">
              <p>Max 5 Guests<br />2 King beds and 1 single bed</p>
              <p className="price">$10</p>
            </div>
          </div>
        </div>
        ...
        <div className="product-box">
          ...
          <div className="product-desbox">
            ...
            <div className="product-des">
              <p>Max 10 Guests<br />4 King beds and 2 single beds</p>
              <p className="price">$10</p>
            </div>
          </div>
        </div>
